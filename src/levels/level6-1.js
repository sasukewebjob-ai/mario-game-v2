...
// ピノキオ部屋ワープ天井パイプ（1つ目の落とし穴後 x=960, addRow(920,H-5T)上からジャンプで入れる）
pipes.push({x:960,y:0,w:TILE*2,h:5*TILE,bounceOffset:0,isWarp:true,ceiling:true,variant:'pinocchio'});
// ★ 上空パタパタ（2段JMP対策）
