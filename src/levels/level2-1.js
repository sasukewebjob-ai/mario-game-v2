...
export function buildLevel_2_1(){
  ...
  // パイプ（ワープ2本、通常2本）
  [[500,2,'desert1'],[1400,3,false],[3100,2,'pswitch_bridge'],[4300,3,'yoshi2'],[5600,2,false]].forEach(([px,ph,warp])=>{
...
pipes.push({x:5200,y:0,w:TILE*2,h:6*TILE,bounceOffset:0,isWarp:false,ceiling:true});
pipes.push({x:1800,y:0,w:TILE*2,h:7*TILE,bounceOffset:0,isWarp:false,ceiling:true});
pipes.push({x:3500,y:0,w:TILE*2,h:5*TILE,bounceOffset:0,isWarp:false,ceiling:true});
piranhas.push({x:5224,baseY:6*TILE,y:6*TILE,w:16,h:TILE,phase:piranhas.length*0.7,alive:true,maxUp:TILE*1.5,ceiling:true});
