...
// ★ 新敵（CP2以降・クッパアリーナ前廊下）
enemies.push({x:6550,y:2*TILE,w:TILE,h:TILE,vx:-1.2,vy:0,alive:true,type:'spikeTop',state:'walk',baseX:6550,range:80,walkFrame:0,walkTimer:0,facing:-1});
...
enemies.push({x:6700,y:H-2*TILE,w:TILE,h:TILE,vx:-1.5,vy:0,alive:true,type:'spiny',state:'walk',walkFrame:0,walkTimer:0,onGround:false,facing:-1});
