...
movingPlats.push(
  ...
  // ★ 最下段コイン（縦コイン柱底部 H-3*TILE）の下に長い動く足場を追加（位置をH-2*TILEに調整）
  {x:250, y:H-2*TILE,w:TILE*5,h:12,type:'h',ox:250, range:120,spd:1.3},
  {x:800, y:H-2*TILE,w:TILE*5,h:12,type:'h',ox:800, range:120,spd:1.4},
  {x:1400,y:H-2*TILE,w:TILE*5,h:12,type:'h',ox:1400,range:130,spd:1.3},
  {x:2000,y:H-2*TILE,w:TILE*5,h:12,type:'h',ox:2000,range:130,spd:1.5},
  {x:2550,y:H-2*TILE,w:TILE*5,h:12,type:'h',ox:2550,range:120,spd:1.3}
);
