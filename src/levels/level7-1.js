...
export function buildLevel_7_1(){
  ...
  // Z4
  platforms.push({x:3700, y:H-5*TILE, w:TILE,h:TILE,type:'question',hit:false,hasMush:true,bounceOffset:0}); // 3700<3800(gap) ✓
  ...
  pipes.push({x:3200, y:H-3*TILE,w:TILE*2,h:TILE*2,bounceOffset:0,isWarp:true,variant:'pipeFort1'});
  // パックンフラワー（ワープ土管以外）
  ...
  [{x:776},{x:1600},{x:2700},{x:4300},{x:5100},{x:6000},{x:6900}
  ...
  pipes.push({x:4700,y:0,w:TILE*2,h:6*TILE,bounceOffset:0,isWarp:false,ceiling:true});
  pipes.push({x:2500,y:0,w:TILE*2,h:6*TILE,bounceOffset:0,isWarp:false,ceiling:true});
  pipes.push({x:6100,y:0,w:TILE*2,h:5*TILE,bounceOffset:0,isWarp:false,ceiling:true});
  piranhas.push({x:4724,baseY:6*TILE,y:6*TILE,w:16,h:TILE,phase:piranhas.length*0.7,alive:true,maxUp:TILE*1.5,ceiling:true});
