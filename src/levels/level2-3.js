...
export function buildLevel_2_3(){
  ...
  pipes.push({x:2400,y:0,w:TILE*2,h:2*TILE,bounceOffset:0,isWarp:false,ceiling:true});
  pipes.push({x:5800,y:0,w:TILE*2,h:4*TILE,bounceOffset:0,isWarp:false,ceiling:true});
