...
export function buildLevel_3_2(){
  ...
  [[800,3,'forest1'],[2500,2,false],[3500,3,'pswitch_maze'],[4200,4,'forest2'],[6400,2,false]].forEach(([px,ph,warp])=>{
  ...
  pipes.push({x:1800,y:0,w:TILE*2,h:2*TILE,bounceOffset:0,isWarp:false,ceiling:true});
  pipes.push({x:3800,y:0,w:TILE*2,h:4*TILE,bounceOffset:0,isWarp:false,ceiling:true});
